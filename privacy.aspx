<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="privacy.aspx.cs" Inherits="VSM.home.WebForm8" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container shadow-lg  my-3 p-3">
        <div class="text-uppercase bg-secondary card-header"><h1>Privacy and Policies</h1></div>
            <p>
                Effective date: March 27, 2020</p>
            <p>
                TransparenTech LLC ("us", "we", or "our") operates the https://www.stockmarketeye.com
            ...
            <p>
                ...
                otherwise defined in this Privacy Policy, terms used in this Privacy Policy have
                the same meanings as in our Terms and Conditions, accessible from https://www.stockmarketeye.com</p>
            <h2>
                Definitions</h2>
            <ul>
                <li>
                    ...
                    <p>
                        Service is the https://www.stockmarketeye.com website operated by TransparenTech
                        LLC</p>
                </li>
                <li>
                    <p>
                ...
                <li>
                    <p>
                        <strong>Data Controller</strong></p>
                    <p>
                        Data Controller means the natural or legal person who (either alone or jointly or
                ...
                <li>
                    <p>
                        <strong>Data Processors (or Service Providers)</strong></p>
                    <p>
                ...
                <li>
                    <p>
                        <strong>Data Subject (or User)</strong></p>
                    <p>
                        Data Subject is any living individual who is using our Service and is the subject
                        of Personal Data.</p>
                </li>
            </ul>
            <h2>
            ...
            <h4>
                StockMarketEye App</h4>
            <p>
                When you purchase our desktop application, we may ask you to provide us with certain
            ...
            <p>
                ...
                materials and other information regarding our products. You may opt out of receiving
            ...
            <p>
                We maintain a customer database of the personal information you submitted at time
                of purchase. We use this information to verify your license key as well as for verification
                in case you lose your license key.</p>
            <h4>
                On-Line Sync Data</h4>
            <p>
                While using the "On-Line Sync" portion of our Service, we ask you to provide us
                with certain personally identifiable information so that we can identify your data
                stored in the Service. Personally identifiable information includes:</p>
            <ul>
                <li>Email address</li>
            </ul>
            <p>
                We use this Personal Data to identify and maintain your data within our On-Line
                Sync Service. We use advanced encryption approved and used by the U.S Government
                to encrypt all data in the On-Line Sync Service. Brokerage account access information
                (username, password and account number) is NOT stored in the On-Line Sync Service.
                Your On-Line Sync Service data is never shared with any 3rd party. You may request
                removal of your data from the On-Line Sync Service by contacting us by email.</p>
            <h4>
                Usage Data</h4>
            <p>
            ...
            <ul>
                ...
                <li><strong>Advertising Cookies.</strong> Advertising Cookies are used to serve you
                    with advertisements that may be relevant to you and your interests. </li>
            </ul>
            <h2>
                Use of Data</h2>
            <p>
                TransparenTech LLC uses the collected data for various purposes:</p>
            <ul>
                ...
                <li>To verify your license key and aid in retrieving lost license keys.</li>
            </ul>
            <h2>
                Legal Basis for Processing Personal Data Under General Data Protection Regulation
                (GDPR)</h2>
            <p>
                If you are from the European Economic Area (EEA), TransparenTech LLC legal basis
                ...
                it.</p>
            <p>
                TransparenTech LLC may process your Personal Data because:</p>
            <ul>
            ...
            <p>
                TransparenTech LLC will retain your Personal Data only for as long as is necessary
            ...
            <p>
                TransparenTech LLC will also retain Usage Data for internal analysis purposes. Usage
            ...
            <p>
                TransparenTech LLC will take all steps reasonably necessary to ensure that your
            ...
            <h3>
                Business Transaction</h3>
            <p>
                If TransparenTech LLC is involved in a merger, acquisition or asset sale, your Personal
            ...
            <h3>
                Disclosure for Law Enforcement</h3>
            <p>
                Under certain circumstances, TransparenTech LLC may be required to disclose your
            ...
            <p>
                TransparenTech LLC may disclose your Personal Data in the good faith belief that
                such action is necessary to:</p>
            <ul>
                <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of TransparenTech LLC</li>
            ...
            <p>
                ...
                over the Internet, or method of electronic storage is 100% secure. While we strive
            ...
            <p>
                ...
                in your web browser to inform websites that you do not want to be tracked.</p>
            <p>
                You can enable or disable Do Not Track by visiting the Preferences or Settings page
                of your web browser.</p>
            <h2>
                Your Data Protection Rights Under General Data Protection Regulation (GDPR)</h2>
            <p>
                If you are a resident of the European Economic Area (EEA), you have certain data
                protection rights. TransparenTech LLC aims to take reasonable steps to allow you
                to correct, amend, delete, or limit the use of your Personal Data.</p>
            <p>
            ...
            <ul>
                <li>
                    <p>
                        <strong>The right to access, update or to delete the information we have on you.</strong>
                        ...
                        these actions yourself, please contact us to assist you.</p>
                </li>
                <li>
                    <p>
                ...
                <li>
                    <p>
                        ...
                        and commonly used format.</p>
                </li>
                <li>
                    <p>
                        <strong>The right to withdraw consent.</strong> You also have the right to withdraw
                        your consent at any time where TransparenTech LLC relied on your consent to process
            ...
            <ul>
                <li>
                    ...
                    <p>
                        ...
                        collected data to contextualize and personalize the ads of its own advertising network.</p>
                    <p>
                    ...
                    <p>
                        ...
                        Privacy &amp; Terms web page: <a href="http://www.google.com/intl/en/policies/privacy/">
            ...
            <p>
                ...
                and maintain our Service.</p>
            <ul>
                <li>
                    <p>
                        <strong>Google AdSense &amp; DoubleClick Cookie</strong></p>
                    <p>
                        ...
                        based on their visit to our Service or other websites on the Internet.</p>
                    <p>
                        You may opt out of the use of the DoubleClick Cookie for interest-based advertising
                        by visiting the Google Ads Settings web page: <a href="http://www.google.com/ads/preferences/">
            ...
            <p>
                ...
                use third-party services for payment processing (e.g. payment processors).</p>
            <p>
            ...
            <ul>
                <li>
                    ...
                    <p>
                        Their Privacy Policy can be viewed at <a href="#"></a></p>
                </li>
            </ul>
            <h2>
            ...
            <ul>
                <li>By email: support@vsm.com</li>
            </ul>
            <br>
            <br>
            <br>
