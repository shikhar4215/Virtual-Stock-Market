<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="VSM_Final.Company.Dashboard" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-5">
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-3 mt-sm-3">
                <div class="card shadow-lg bg-danger">
                    <div class="card-body  justify-content-around">
                        <center><i class="fa fa-flag text-white fa-3x"></i></center>

                        <center>number of listed shares</center>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-3 mt-sm-3">
                <div class="card shadow-lg bg-info">
                    <div class="card-body justify-content-around">
                        <center><i class="fa fa-shopping-basket text-warning fa-3x"></i></center>

                        <center>number of sold shares</center>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-3 mt-sm-3">
                <div class="card shadow-lg bg-secondary">
                    <div class="card-body justify-content-around">
                        <center><i class="far fa-money-bill-alt text-success fa-3x"></i></center>
                        <center>total market value</center>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-3 mt-sm-3">
                <div class="card shadow-lg bg-primary">
                    <div class="card-body justify-content-around">
                        <center><i class="fa fa-users text-dark fa-3x"></i></center>
    ...
    <div id="sharedetails" class="container shadow-lg mt-5 mb-5 p-4">
        <div class="row">
            <div class="col">
