<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="getUnVerifiedCompany.aspx.cs" Inherits="VSM_Final.Admin.Script.getUnVerifiedCompany" %>
            ...
            <tbody>
                <tr>
                    <th rowspan="4" class="pr-5" style="width: 200px;">
                        <img src="<%= (dr.GetValue(6).ToString()) %>" alt="Logo" id="Profile" />
                    </th>
                    <th>company Name
                    </th>
                    <th>Contact No
                ...
                <tr>
                    <td class="text-center " colspan="4">
                        <button id="Block" class="btn btn-success btn-lg" onclick="VerifyCompany(); return false;"> Verify </button>
